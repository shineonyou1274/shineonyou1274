...
export const BATTLE_MESSAGES = {
  good: [
    "급소에 맞았다! 상대방의 마음이 활짝 열렸어!",
    "효과는 굉장했다! 신뢰도가 급상승!",
    "'{move}' 성공! 상대방이 크게 감동했다!",
    "상대방의 특수방어가 크게 떨어졌다! 대화가 술술 풀린다!",
    "유대감이 깊어졌다! 완벽한 커뮤니케이션!",
    "상대방이 동료가 되고 싶어한다! 우정 획득!",
    "명중률 100%! 진심이 정확하게 전해졌다!"
  ],
  bad: [
    "효과가 별로인 듯하다... 상대방이 마음을 닫아버렸다.",
    "공격은 빗나갔다! 오해가 눈덩이처럼 커졌다.",
    "'{move}' 실패... 상대방은 혼란에 빠졌다!",
    "상대방이 반동 데미지를 입었다! 관계가 심각하게 악화됨.",
    "상대방은 도망쳤다! 더 이상 대화할 수 없다...",
    "상대방이 '분노' 기술을 사용했다! 상황 종료.",
    "치명적인 실수를 했다! 회복할 수 없는 데미지..."
  ]
};